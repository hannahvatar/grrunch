// zrender/lib/@5.6.0 downloaded from https://cdn.jsdelivr.net/npm/zrender@5.6.0/lib/

<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8">
		<meta name="description" content="zrender CDN by jsDelivr - A free, fast, and reliable Open Source CDN for npm and GitHub">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<title>zrender CDN by jsDelivr - A free, fast, and reliable Open Source CDN</title>
		<style>
			body {
	...
	<body>
		<div class="container">
			<div class="header">
				<h1>zrender CDN files</h1>

				<a class="badge" href="https://www.jsdelivr.com/package/npm/zrender" title="jsDelivr monthly hits">
					<img alt="jsDelivr monthly hits badge" src="https://data.jsdelivr.com/v1/package/npm/zrender/badge">
				</a>
			</div>
			...
			<div class="path">
				<ol itemscope itemtype="https://schema.org/BreadcrumbList">
					<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
						<a itemscope itemtype="https://schema.org/WebPage" itemprop="item"
						   itemid="/npm/zrender@5.6.0/"
						   href="/npm/zrender@5.6.0/" rel="nofollow">
							<span itemprop="name">zrender@5.6.0</span></a> /
				...
				<select class="versions select-css">
					<option value="zrender@5.6.0">zrender@5.6.0</option>
					<option value="zrender@5.5.0">zrender@5.5.0</option>
					<option value="zrender@5.4.4">zrender@5.4.4</option>
					<option value="zrender@5.4.3">zrender@5.4.3</option>
					<option value="zrender@5.4.2">zrender@5.4.2</option>
					<option value="zrender@5.4.1">zrender@5.4.1</option>
					<option value="zrender@5.4.0">zrender@5.4.0</option>
					<option value="zrender@5.3.2">zrender@5.3.2</option>
					<option value="zrender@5.3.1">zrender@5.3.1</option>
					<option value="zrender@5.3.0">zrender@5.3.0</option>
					<option value="zrender@5.2.1">zrender@5.2.1</option>
					<option value="zrender@5.2.0">zrender@5.2.0</option>
					<option value="zrender@5.1.1">zrender@5.1.1</option>
					<option value="zrender@5.1.0">zrender@5.1.0</option>
					<option value="zrender@5.0.4">zrender@5.0.4</option>
					<option value="zrender@5.0.3">zrender@5.0.3</option>
					<option value="zrender@5.0.2">zrender@5.0.2</option>
					<option value="zrender@5.0.1">zrender@5.0.1</option>
					<option value="zrender@5.0.0">zrender@5.0.0</option>
					<option value="zrender@5.0.0-rc.1">zrender@5.0.0-rc.1</option>
					<option value="zrender@5.0.0-beta.2">zrender@5.0.0-beta.2</option>
					<option value="zrender@5.0.0-beta.1">zrender@5.0.0-beta.1</option>
					<option value="zrender@5.0.0-alpha.3">zrender@5.0.0-alpha.3</option>
					<option value="zrender@5.0.0-alpha.2">zrender@5.0.0-alpha.2</option>
					<option value="zrender@5.0.0-alpha.1">zrender@5.0.0-alpha.1</option>
					<option value="zrender@4.3.3">zrender@4.3.3</option>
					<option value="zrender@4.3.2">zrender@4.3.2</option>
					<option value="zrender@4.3.1">zrender@4.3.1</option>
					<option value="zrender@4.3.0">zrender@4.3.0</option>
					<option value="zrender@4.2.0">zrender@4.2.0</option>
					<option value="zrender@4.1.2">zrender@4.1.2</option>
					<option value="zrender@4.1.1">zrender@4.1.1</option>
					<option value="zrender@4.1.0">zrender@4.1.0</option>
					<option value="zrender@4.0.7">zrender@4.0.7</option>
					<option value="zrender@4.0.6">zrender@4.0.6</option>
					<option value="zrender@4.0.5">zrender@4.0.5</option>
					<option value="zrender@4.0.4">zrender@4.0.4</option>
					<option value="zrender@4.0.3">zrender@4.0.3</option>
					<option value="zrender@4.0.2">zrender@4.0.2</option>
					<option value="zrender@4.0.1">zrender@4.0.1</option>
					<option value="zrender@4.0.0">zrender@4.0.0</option>
					<option value="zrender@3.7.4">zrender@3.7.4</option>
					<option value="zrender@3.7.3">zrender@3.7.3</option>
					<option value="zrender@3.7.2">zrender@3.7.2</option>
					<option value="zrender@3.7.1">zrender@3.7.1</option>
					<option value="zrender@3.7.0">zrender@3.7.0</option>
					<option value="zrender@3.6.3">zrender@3.6.3</option>
					<option value="zrender@3.6.2">zrender@3.6.2</option>
					<option value="zrender@3.6.1">zrender@3.6.1</option>
					<option value="zrender@3.6.0">zrender@3.6.0</option>
					<option value="zrender@3.5.2">zrender@3.5.2</option>
					<option value="zrender@3.5.1">zrender@3.5.1</option>
					<option value="zrender@3.5.0">zrender@3.5.0</option>
					<option value="zrender@3.4.4">zrender@3.4.4</option>
					<option value="zrender@3.4.3">zrender@3.4.3</option>
					<option value="zrender@3.4.2">zrender@3.4.2</option>
					<option value="zrender@3.4.1">zrender@3.4.1</option>
					<option value="zrender@3.4.0">zrender@3.4.0</option>
					<option value="zrender@3.3.0">zrender@3.3.0</option>
					<option value="zrender@3.2.2">zrender@3.2.2</option>
					<option value="zrender@3.2.1">zrender@3.2.1</option>
					<option value="zrender@3.2.0">zrender@3.2.0</option>
					<option value="zrender@3.1.3">zrender@3.1.3</option>
					<option value="zrender@3.1.2">zrender@3.1.2</option>
					<option value="zrender@3.1.1">zrender@3.1.1</option>
					<option value="zrender@3.1.0">zrender@3.1.0</option>
					<option value="zrender@3.0.9">zrender@3.0.9</option>
					<option value="zrender@3.0.8">zrender@3.0.8</option>
					<option value="zrender@3.0.7">zrender@3.0.7</option>
					<option value="zrender@3.0.6">zrender@3.0.6</option>
					<option value="zrender@3.0.5">zrender@3.0.5</option>
					<option value="zrender@3.0.4">zrender@3.0.4</option>
					<option value="zrender@3.0.3">zrender@3.0.3</option>
					<option value="zrender@3.0.2">zrender@3.0.2</option>
					<option value="zrender@3.0.1">zrender@3.0.1</option>
					<option value="zrender@3.0.0">zrender@3.0.0</option>
					<option value="zrender@2.0.2">zrender@2.0.2</option>
				</select>
			</div>
				...
				<table>
					...
					<tr>
						<td class="name">
							...
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/animation/">animation</a>
						</td>
						<td class="size"></td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 5C2 3.89543 2.89543 3 4 3H8.46482C8.79917 3 9.1114 3.1671 9.29687 3.4453L10.7031 5.5547C10.8886 5.8329 11.2008 6 11.5352 6H16C17.1046 6 18 6.89543 18 8V15C18 16.1046 17.1046 17 16 17H4C2.89543 17 2 16.1046 2 15V5Z" fill="#5C667A"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/canvas/">canvas</a>
						</td>
						<td class="size"></td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 5C2 3.89543 2.89543 3 4 3H8.46482C8.79917 3 9.1114 3.1671 9.29687 3.4453L10.7031 5.5547C10.8886 5.8329 11.2008 6 11.5352 6H16C17.1046 6 18 6.89543 18 8V15C18 16.1046 17.1046 17 16 17H4C2.89543 17 2 16.1046 2 15V5Z" fill="#5C667A"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/contain/">contain</a>
						</td>
						<td class="size"></td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 5C2 3.89543 2.89543 3 4 3H8.46482C8.79917 3 9.1114 3.1671 9.29687 3.4453L10.7031 5.5547C10.8886 5.8329 11.2008 6 11.5352 6H16C17.1046 6 18 6.89543 18 8V15C18 16.1046 17.1046 17 16 17H4C2.89543 17 2 16.1046 2 15V5Z" fill="#5C667A"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/core/">core</a>
						</td>
						<td class="size"></td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 5C2 3.89543 2.89543 3 4 3H8.46482C8.79917 3 9.1114 3.1671 9.29687 3.4453L10.7031 5.5547C10.8886 5.8329 11.2008 6 11.5352 6H16C17.1046 6 18 6.89543 18 8V15C18 16.1046 17.1046 17 16 17H4C2.89543 17 2 16.1046 2 15V5Z" fill="#5C667A"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/debug/">debug</a>
						</td>
						<td class="size"></td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 5C2 3.89543 2.89543 3 4 3H8.46482C8.79917 3 9.1114 3.1671 9.29687 3.4453L10.7031 5.5547C10.8886 5.8329 11.2008 6 11.5352 6H16C17.1046 6 18 6.89543 18 8V15C18 16.1046 17.1046 17 16 17H4C2.89543 17 2 16.1046 2 15V5Z" fill="#5C667A"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/dom/">dom</a>
						</td>
						<td class="size"></td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 5C2 3.89543 2.89543 3 4 3H8.46482C8.79917 3 9.1114 3.1671 9.29687 3.4453L10.7031 5.5547C10.8886 5.8329 11.2008 6 11.5352 6H16C17.1046 6 18 6.89543 18 8V15C18 16.1046 17.1046 17 16 17H4C2.89543 17 2 16.1046 2 15V5Z" fill="#5C667A"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/graphic/">graphic</a>
						</td>
						<td class="size"></td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 5C2 3.89543 2.89543 3 4 3H8.46482C8.79917 3 9.1114 3.1671 9.29687 3.4453L10.7031 5.5547C10.8886 5.8329 11.2008 6 11.5352 6H16C17.1046 6 18 6.89543 18 8V15C18 16.1046 17.1046 17 16 17H4C2.89543 17 2 16.1046 2 15V5Z" fill="#5C667A"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/mixin/">mixin</a>
						</td>
						<td class="size"></td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 5C2 3.89543 2.89543 3 4 3H8.46482C8.79917 3 9.1114 3.1671 9.29687 3.4453L10.7031 5.5547C10.8886 5.8329 11.2008 6 11.5352 6H16C17.1046 6 18 6.89543 18 8V15C18 16.1046 17.1046 17 16 17H4C2.89543 17 2 16.1046 2 15V5Z" fill="#5C667A"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/svg/">svg</a>
						</td>
						<td class="size"></td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 5C2 3.89543 2.89543 3 4 3H8.46482C8.79917 3 9.1114 3.1671 9.29687 3.4453L10.7031 5.5547C10.8886 5.8329 11.2008 6 11.5352 6H16C17.1046 6 18 6.89543 18 8V15C18 16.1046 17.1046 17 16 17H4C2.89543 17 2 16.1046 2 15V5Z" fill="#5C667A"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/svg-legacy/">svg-legacy</a>
						</td>
						<td class="size"></td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 5C2 3.89543 2.89543 3 4 3H8.46482C8.79917 3 9.1114 3.1671 9.29687 3.4453L10.7031 5.5547C10.8886 5.8329 11.2008 6 11.5352 6H16C17.1046 6 18 6.89543 18 8V15C18 16.1046 17.1046 17 16 17H4C2.89543 17 2 16.1046 2 15V5Z" fill="#5C667A"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/tool/">tool</a>
						</td>
						<td class="size"></td>
					</tr>
					<tr>
						<td class="name">
							...
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/all.d.ts">all.d.ts</a>
						</td>
					...
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/all.js">all.js</a>
						</td>
						<td class="size">277 B</td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/config.d.ts">config.d.ts</a>
						</td>
						<td class="size">279 B</td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/config.js">config.js</a>
						</td>
						<td class="size">436 B</td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/Element.d.ts">Element.d.ts</a>
						</td>
						<td class="size">8.59 KB</td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/Element.js">Element.js</a>
						</td>
						<td class="size">37.8 KB</td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/export.d.ts">export.d.ts</a>
						</td>
					...
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/export.js">export.js</a>
						</td>
					...
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/Handler.d.ts">Handler.d.ts</a>
						</td>
					...
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/Handler.js">Handler.js</a>
						</td>
						<td class="size">10.65 KB</td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/PainterBase.d.ts">PainterBase.d.ts</a>
						</td>
						<td class="size">797 B</td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/PainterBase.js">PainterBase.js</a>
						</td>
						<td class="size">11 B</td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/Storage.d.ts">Storage.d.ts</a>
						</td>
						<td class="size">751 B</td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/Storage.js">Storage.js</a>
						</td>
						<td class="size">5.08 KB</td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/zrender.d.ts">zrender.d.ts</a>
						</td>
						<td class="size">3.58 KB</td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/zrender@5.6.0/lib/zrender.js">zrender.js</a>
						</td>
						<td class="size">9.71 KB</td>
					</tr>
					</tbody>
				</table>
			</div>
			...
			<div class="landing">
				<p class="left">Free Open Source CDN for <strong>zrender</strong></p>

				<p class="right">
					Looking for a nice landing page for your package?
					<a href="https://www.jsdelivr.com/package/npm/zrender">https://www.jsdelivr.com/package/npm/zrender</a>
				</p>
			</div>
		</div>
		...
		<script>
			...
			[].slice.call(versions.querySelectorAll('option')).forEach(function(option) {
				if (option.value === 'zrender@5.6.0') {
					option.selected = true;
				}
			});

			versions.addEventListener('change', function() {
				location.pathname = '/npm/' + this.value + '/lib/';
			});
		</script>
	</body>
</html>